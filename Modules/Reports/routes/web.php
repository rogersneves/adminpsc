...
Route::middleware(['auth', 'verified', 'resolve.tenant'])->group(function () {
    ...
    // Geração de PDF/Excel é síncrona e cara (docs/04-Seguranca.md pede rate limiting
    // em endpoints de exportação, Fase 9). throttle:30,1 = 30 exportações/min por IP.
